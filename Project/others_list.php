...
$sql = "SELECT * FROM subscriber_list WHERE email NOT LIKE '%outlook.com' AND email NOT LIKE '%gmail.com' AND email NOT LIKE '%yahoo.com'";
...
<body>
    ...
    <a href="yahoo.php">Yahoo</a>
    <a href="outlook_list.php">Outlook</a>
